...
const Footer = ( {baseurl, activeLink} ) => {

    const isActiveLink = (link) => {
        if (activeLink === link) {
            return "nav_link--active";
        }
        return "";
    }

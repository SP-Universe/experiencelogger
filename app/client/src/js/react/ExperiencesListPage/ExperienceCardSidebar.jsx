...
function ExperienceCardSidebar( {location} ) {
    return (
        <div className="location_sidebar">
            ...
            <div className="numbers" data-behaviour="showhide_numbers">
                <p>999 Experiences</p>
                <p className="sideinfo">999 Active</p>
                <p className="sideinfo">999 In Maintenance</p>
                <p className="sideinfo">999 Coming Soon</p>
                <p className="sideinfo">999 Defunct</p>
                <p className="sideinfo">999 Other</p>
                <hr/>

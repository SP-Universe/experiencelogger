<div class="loggedexperience_card" data-behaviour="filtered_log" data-experiencetype="$Experience.Type.Title">
    ...
    <% if $Experience.PhotoGalleryImages %>
        <div class="background_image">
            $Experience.PhotoGalleryImages.First.Image.FocusFill(600, 600)
        </div>
    <% else_if $Experience.Image %>
        <div class="background_image">
            $Experience.Image.FocusFill(600, 600)
        </div>
    <% end_if %>
    <a class="moreinfo_button" href="$Experience.Link">></a>
</div>

<div class="location_entry_wrap">
    ...
    <a href="$Link" class="location_entry">
        ...
        <div class="location_entry_content">
            ...
            <p class="location_distance" data-behaviour="distance" data-loc="$Coordinates"></p>
            </p>
        </div>
    </a>

    <% if $TopScope.CurrentUser %>
        <a href="$TopScope.Link('changeFavourite')/$LinkTitle" class="location_favouritemarker">
            <% if $IsFavourite %>

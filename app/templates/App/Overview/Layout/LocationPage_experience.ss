                        ...
                        <div class="experiencegallery_slider swiper-wrapper">
                            <% loop PhotoGalleryImages %>
                                <div class="swiper-slide">
                                    <a data-gallery="gallery" data-glightbox="description: $Title" data-caption="$Title" class="experienceimage" data-noloadingscreen="true" href="$Image.FitMax(2000,2000).URL">

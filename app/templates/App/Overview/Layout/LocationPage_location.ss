        ...
        <div class="section_content">
            ...
            <div class="location_experiences">
                <div class="search_bar" id="search-experience-bar">
                    ...
                    <a class="search_bar_filterbutton" data-behaviour="showhide_filter">
                    ...
                    <div class="search_bar_filtersettings">
                        <select name="type" id="search-experience-type">
                            <option value="all">All Types</option>
                            <% loop $GroupedExperiences %>
                                <option value="$Children.First.Type.PluralName">Type: $Children.First.Type.PluralName</option>
                            <% end_loop %>
                        </select>
